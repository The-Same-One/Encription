...
class DecodedPage extends StatefulWidget {
  @override
  _DecodedPageState createState() {
    return _DecodedPageState();
  }
}
...
class _DecodedPageState extends State<DecodedPage> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyDecodedPage(title: 'Odszyfruj'),
    );
  }
}

class MyDecodedPage extends StatefulWidget {
  const MyDecodedPage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<MyDecodedPage> createState() => _MyDecodedPageState();
}

class _MyDecodedPageState extends State<MyDecodedPage> {
          ...
          children: <Widget>[
            TextField(
              ...
              decoration: InputDecoration(
                hintText: "Wiadomość do odszyfrowania",
              ),
            ),
            Container(
              height: 5,
            ...
            Row(
              children: [
                ...
                _NoteButton("ODSZYFRUJ", Colors.deepPurple, _decoded),
              ],
            ),
            Container(
              height: 5,
